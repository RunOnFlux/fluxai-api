    ...
    <div className="w-full max-w-screen-lg mx-auto items-center p-10">
      ...
      <div className="w-full max-w-screen-lg mx-auto grid grid-cols-1 md:grid-cols-2 gap-14 items-center h-full">
        <div className="flex flex-col items-center justify-between border border-gray-200 rounded-lg p-10 h-full">
          <div className="flex flex-col w-full max-w-[500px] justify-center items-center gap-4">
            <a
              href="/chat"
              className="text-2xl sm:text-4xl text-red-500/80 font-bold"
            >
              FluxGPT
            </a>
        ...
        <div className="flex flex-col items-center justify-between border border-gray-200 rounded-lg p-10 h-full">
          <div className="flex flex-col w-full max-w-[500px] justify-center items-center gap-4">
            <a
              href="/image"
              className="text-2xl sm:text-4xl text-orange-500/80 font-bold"
            >
              FluxONE
            </a>
            <p className="text-sm sm:text-lg text-center break-words">
